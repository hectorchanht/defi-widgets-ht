...
contract-interact can help dapp developers trigger contract transactions, query contract methods, etc. With contract-interact, dapp developers will be able to:
